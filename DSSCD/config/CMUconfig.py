...
BASE_PATH = '/volumes1/self_supevised_CD'
#PRETRAIN_MODEL_PATH = os.path.join(BASE_PATH,'pretrain')
DATA_PATH = '/volumes1/self_supevised_CD/Dataset/VL-CMU-CD'
TRAIN_DATA_PATH = os.path.join(DATA_PATH)
TRAIN_LABEL_PATH = os.path.join(DATA_PATH)
TRAIN_TXT_PATH = os.path.join(TRAIN_DATA_PATH,'train_split.txt')
...
VAL_TXT_PATH = os.path.join(VAL_DATA_PATH,'test_split.txt')
