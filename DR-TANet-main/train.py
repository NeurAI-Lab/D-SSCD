...
class Train:
    ...
    def run(self):
        if self.args.ssl_path == 'nb_pre':
            ssl_path = '/data/output/sscd/runs2/resnet50_bs_16/Sat_Jun_19_12:50:57_2021/checkpoint_model_500_model1.pth'
        elif self.args.ssl_path == 'nb_nopre':
            ssl_path = '/data/output/sscd/runs2/resnet50_bs_16/Wed_Jun_23_10:29:17_2021/checkpoint_model_500_model1.pth'
        elif self.args.ssl_path == 'bd_pre':
            ssl_path = '/data/output/sscd/runs2/resnet50_bs_16/Mon_Jun__7_23:29:00_2021/checkpoint_model_500_model1.pth'
        elif self.args.ssl_path == 'bd_nopre':
            ssl_path = '/data/output/sscd/runs2/resnet50_bs_16/Mon_Jun__7_23:28:37_2021/checkpoint_model_500_model1.pth'
        elif self.args.ssl_path == 'barlow_im':
            ssl_path = '/data/input/VL-CMU-CD/pretrain/resnet50_barlow.pth'
        elif self.args.ssl_path == 'barlow_im+ssl':
            ssl_path = '/data/output/sscd/runs2/resnet50_bs_16/Sat_Sep__4_11:23:17_2021/checkpoint_model_500_model1.pth'
        else:
            ssl_path = 'None'

        self.model = TANet(self.args.encoder_arch, self.args.local_kernel_size, self.args.attn_stride,
                           self.args.attn_padding, self.args.attn_groups, self.args.drtam, self.args.refinement, self.args.pretrain, self.args.sslpretrain, ssl_path)
...
if __name__ =="__main__":
    ...
    parser.add_argument('--data_num', type=float, required=True)       #[0.1,0.5,0.01]
