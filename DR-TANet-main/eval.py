...
class Evaluate:
    ...
    def run(self):
        ...
        self.model = TANet(self.args.encoder_arch, self.args.local_kernel_size, self.args.attn_stride,
                           self.args.attn_padding, self.args.attn_groups, self.args.drtam, self.args.refinement, False,False,'None')
...
class evaluate_pcd(Evaluate):
    ...
    def run(self, set):
        ...
        self.fn_model = pjoin(self.args.checkpointdir, 'set{0:1d}'.format(self.set), 'checkpointdir', '00120000.pth')
...
class evaluate_cmu(Evaluate):
    ...
    def Init(self):
        ...
        self.fn_img = pjoin(self.dir_img, '{0}-{1:08d}.png'.format(self.ds, self.index))
        self.fn_model = pjoin(self.args.checkpointdir, 'checkpointdir', '00070050.pth')  #00070050  00035100 00070050.pth
